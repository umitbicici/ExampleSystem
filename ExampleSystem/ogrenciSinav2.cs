...
{
    public partial class ogrenciSinav2 : Form
    {
        ...
        public void sinavKaydet()
        {
            ...
            komut.Parameters.Add("@sinavAdi", "2.Sınav");
        ...
        public void sorulariGetir()
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("Select * from tblSoru where Cevap='0' or Cevap='-1'", baglanti);
            SqlCommand cmd = new SqlCommand("select count(*) from tblSoru where Cevap='0' or Cevap='-1'", baglanti);
